...
import io.middlepoint.tvsleep.utils.DnsDiscover.Companion.adbPort
...
class DnsDiscover private constructor(
   ...
   *  TODO: is this really needed for AndroidTV devices?
   */
  fun scanAdbPorts() {
    if (started) {
  ...
  val discoveryListener =
    object : NsdManager.DiscoveryListener {
      ...
      override fun onStartDiscoveryFailed(
        ...
        Firebase.crashlytics.log("Discovery failed: Error code:$errorCode")
