...
import io.middlepoint.tvsleep.TV_TIMER_PLUS_WEBSITE
...
fun SetupScreen(
  ...
  Row(
    ...
    Column(
      ...
      val logoPainter = painterResource(R.drawable.ic_youtube)

      val androidVersion = Build.VERSION.RELEASE
      val deviceModel = Build.MODEL

      val url = "$TV_TIMER_PLUS_WEBSITE/tvsleep?version=$androidVersion&model=$deviceModel"
      ...
      Image(
        ...
        contentDescription = "QR code referring to the YouTube",
        modifier = Modifier
          .size(350.dp),
      )
